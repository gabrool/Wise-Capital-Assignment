...
# Volatility Feature: Std dev of daily returns * sqrt(252)
...
# Drop incomplete month if data ends mid-month (Crucial for Volatility accuracy)
if out.index[-1].day < 28:
    print(f"Dropping incomplete month: {out.index[-1].date()}")
    out = out.iloc[:-1]
